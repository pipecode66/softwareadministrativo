...
export function DashboardPage() {
  ...
  return <div className="page-stack analytics-page">
    <PageHeader eyebrow="RESUMEN EJECUTIVO · INTERMEDIOS" title={`Hola, ${user?.name.split(' ')[0] ?? 'Administración'}`} description="Una vista clara de las ventas, los cobros y el trabajo de tu equipo." actions={<Link className="btn btn-primary" to="/orders/new"><Plus size={18} />Crear orden</Link>} />
