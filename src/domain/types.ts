...
export type WorkStatus = 'NEW' | 'PENDING_ADMIN_REVIEW' | 'IN_PRINTING' | 'IN_WORKSHOP' | 'PENDING_INSTALLATION' | 'COMPLETED' | 'INSTALLED';
...
export interface Payment { id: string; date: string; amount: number; recordedBy: string }
export interface WorkOrder {
  ...
  createdAt: string; updatedAt: string; version?: number; printing?: Printing;
