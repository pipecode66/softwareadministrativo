CREATE TABLE orders (
  ...
  route varchar(20) NOT NULL CHECK (route IN ('PRINT_ONLY','IMPRENTA','WORKSHOP_ONLY','PRINT_WORKSHOP')),
  ...
  material varchar(30) CHECK (material IN ('Panaflex','V. Corte','V. Impresión','Banner')),
